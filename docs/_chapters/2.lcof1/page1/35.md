...
示例 1：  
![示例1](https://cdn.jsdelivr.net/gh/PasseRR/JavaLeetCode/docs/assets/2/35/e1.png)  
输入：head = [[7,null],[13,0],[11,4],[10,2],[1,0]]  
输出：[[7,null],[13,0],[11,4],[10,2],[1,0]]

示例 2：  
![示例2](https://cdn.jsdelivr.net/gh/PasseRR/JavaLeetCode/docs/assets/2/35/e2.png)  
输入：head = [[1,1],[2,1]]  
输出：[[1,1],[2,1]]

示例 3：  
![示例3](https://cdn.jsdelivr.net/gh/PasseRR/JavaLeetCode/docs/assets/2/35/e3.png)  
